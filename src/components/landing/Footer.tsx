        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            <div className="group inline-block">
              <img
                src={nagaroLogo}
                alt="Nagaro"
                className="h-12 w-auto mb-6 transition-all duration-500 group-hover:scale-105"
              />
            </div>
            ...
            <div className="flex items-center gap-4 mt-8">
              <a
                ...
                className="group relative w-12 h-12 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-white/20 transition-all duration-300 overflow-hidden"
              >
              ...
              {/* <a
                ...
                className="group relative w-12 h-12 rounded-xl bg-white/[0.03] border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-white/20 transition-all duration-300 overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-gray-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                <svg className="relative w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['services.1.title', 'services.2.title', 'services.3.title'].map((key, i) => (
                <li key={i}>
                  <a 
                    href="#services" 
