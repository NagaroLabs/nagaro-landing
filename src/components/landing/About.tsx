      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1/3 h-96 opacity-10 pointer-events-none">
          <svg viewBox="0 0 400 400" className="w-full h-full">
            ...
            <circle cx="200" cy="200" r="150" fill="none" stroke="url(#aboutGradient)" strokeWidth="0.5" className="animate-spin-slow" style={{ transformOrigin: 'center' }} />
            <circle cx="200" cy="200" r="100" fill="none" stroke="url(#aboutGradient)" strokeWidth="0.5" className="animate-reverse-spin" style={{ transformOrigin: 'center' }} />
            <circle cx="200" cy="200" r="50" fill="none" stroke="url(#aboutGradient)" strokeWidth="0.5" className="animate-spin-slower" style={{ transformOrigin: 'center' }} />
          </svg>
        </div>
      </div>
    </section>
