...
const translations = {
  pt: {
    ...
    // Hero
    'hero.tagline': 'Tecnologia de Alto Padrão',
    'hero.title': 'Transformamos ideias em',
    'hero.titleHighlight': 'software de excelência',
    'hero.subtitle': 'Somos especialistas em criar soluções digitais sob medida com arquitetura escalável, código limpo e tecnologia de ponta.',
    ...
    'about.description': 'A Nagaro é um estúdio de tecnologia focado em criar soluções digitais sob medida para empresas que buscam inovação e resultados reais. Combinamos expertise técnica de alto nível com uma abordagem centrada no cliente.',
    ...
    'about.stat1.label': 'Dedicação',
    'about.stat2.value': '∞',
    'about.stat2.label': 'Possibilidades',
    'about.stat3.value': '24/7',
    'about.stat3.label': 'Suporte',

    // Services
    'services.tagline': 'Nossos Serviços',
    'services.title': 'Soluções completas para seu negócio digital',
    'services.subtitle': 'Do conceito à entrega, desenvolvemos produtos digitais com excelência técnica e foco em resultados.',
    ...
    // Footer
    'footer.description': 'Estúdio de tecnologia especializado em soluções digitais sob medida.',
  ...
  en: {
    ...
    // Hero
    'hero.tagline': 'Premium Technology Studio',
    'hero.title': 'We transform ideas into',
    'hero.titleHighlight': 'exceptional software',
    'hero.subtitle': 'We are specialists in creating custom digital solutions with scalable architecture, clean code, and cutting-edge technology.',
    ...
    'about.description': 'Nagaro is a technology studio focused on creating custom digital solutions for companies seeking innovation and real results. We combine high-level technical expertise with a client-centered approach.',
    ...
    'about.stat1.value': '100%',
    'about.stat1.label': 'Dedication',
    'about.stat2.value': '∞',
    'about.stat2.label': 'Possibilities',
    'about.stat3.value': '24/7',
    ...
    'services.subtitle': 'From concept to delivery, we develop digital products with technical excellence and focus on results.',
    ...
    // Footer
    'footer.description': 'Technology studio specialized in custom digital solutions.',
